...
### Data
Our data can be downloaded from [GenImage]([https://zenodo.org/doi/10.5281/zenodo.10997234](https://github.com/GenImage-Dataset/GenImage)). Extract the `.zip` file and place the `data` directory inside the root directory of this repository.
